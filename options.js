...
(function() {
  ...
  const defaultSettings = { autoPrefetch: true, ttlHours: 24, showBadge: true, showLength: true, useCloud: true, cloudApiUrl: "https://your-api.example.com/size", resolutions: ["480p", "720p", "1080p", "1440p"] };
